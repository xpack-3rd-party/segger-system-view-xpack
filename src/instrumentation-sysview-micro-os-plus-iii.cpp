...
namespace os::instrumentation
{
  namespace scheduler
  {
    ...
    unlock (bool state)
    {
      SEGGER_SYSVIEW_RecordU32 (OS_INTEGER_INSTRUMENTATION_ID_SCHEDULER_UNLOCK,
                                static_cast<U32> (state));
    }
...
namespace os::instrumentation
{
  namespace thread
  {
    ...
    {
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_THREAD_DETACH, static_cast<U32> (res));
    }
    ...
    {
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_THREAD_CANCEL, static_cast<U32> (res));
    }
    ...
    void
    flags_wait (os::rtos::thread* thread, unsigned int mask, unsigned int mode)
    {
    ...
    void
    flags_timed_wait_retval (os::rtos::thread* thread, os::rtos::result_t res)
    {
#if defined(OS_INCLUDE_INSTRUMENTATION_EXTRA_VALUES)
      SEGGER_SYSVIEW_RecordU32x2 (
...
namespace os::instrumentation
{
  namespace mutex
  {
    ...
    lock_retval (os::rtos::mutex* mutex, os::rtos::result_t result)
    {
      ...
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_MUTEX_LOCK, static_cast<U32> (result));
    }
    ...
    void
    prio_ceiling_set_retval (os::rtos::mutex* mutex, os::rtos::result_t result)
    {
#if defined(OS_INCLUDE_INSTRUMENTATION_EXTRA_VALUES)
      SEGGER_SYSVIEW_RecordU32x2 (
...
namespace os::instrumentation
{
  namespace semaphore
  {
    ...
    void
    timed_wait_retval (os::rtos::semaphore* semaphore, os::rtos::result_t res)
    {
#if defined(OS_INCLUDE_INSTRUMENTATION_EXTRA_VALUES)
      SEGGER_SYSVIEW_RecordU32x2 (
...
namespace os::instrumentation
{
  namespace message_queue
  {
    ...
    void
    timed_send_retval (os::rtos::message_queue* mqueue, os::rtos::result_t res)
    {
#if defined(OS_INCLUDE_INSTRUMENTATION_EXTRA_VALUES)
      SEGGER_SYSVIEW_RecordU32x2 (
...
namespace os::instrumentation
{
  namespace event_flags
  {
    ...
    void
    wait (os::rtos::event_flags* evflags, unsigned int mask, unsigned int mode)
    {
      SEGGER_SYSVIEW_RecordU32x3 (
    ...
    void
    timed_wait_retval (os::rtos::event_flags* evflags, os::rtos::result_t res)
    {
#if defined(OS_INCLUDE_INSTRUMENTATION_EXTRA_VALUES)
      SEGGER_SYSVIEW_RecordU32x2 (
...
namespace os::instrumentation
{
  namespace condition_variable
  {
    ...
    void
    signal_retval (os::rtos::condition_variable* cond, os::rtos::result_t res)
    {
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_CONDITION_VARIABLE_SIGNAL,
          static_cast<U32> (res));
...
namespace os::instrumentation
{
  namespace posix
  {
    ...
    vopen_retval (void* io, const char* path)
    {
      ...
      SEGGER_SYSVIEW_RecordEndCall (OS_INTEGER_INSTRUMENTATION_ID_POSIX_VOPEN);
    }
    ...
    namespace device
    {
      ...
      {
        os::posix::device* dev = reinterpret_cast<os::posix::device*> (device);
    ...
    mkdir (const char* path, unsigned int mode)
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_MKDIR,
                                   path);
      SEGGER_SYSVIEW_RecordU32 (OS_INTEGER_INSTRUMENTATION_ID_POSIX_MKDIR_MORE,
                                static_cast<U32> (mode));
    }
    ...
    sync_return ()
    {
      SEGGER_SYSVIEW_RecordEndCall (OS_INTEGER_INSTRUMENTATION_ID_POSIX_SYNC);
    }
    ...
    chmod (const char* path, unsigned int mode)
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_CHMOD,
                                   path);
      SEGGER_SYSVIEW_RecordU32 (OS_INTEGER_INSTRUMENTATION_ID_POSIX_CHMOD_MORE,
                                static_cast<U32> (mode));
    }
    ...
    stat (const char* path, void* buf)
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_STAT,
                                   path);
      SEGGER_SYSVIEW_RecordU32 (OS_INTEGER_INSTRUMENTATION_ID_POSIX_STAT_MORE,
                                reinterpret_cast<U32> (buf));
    }
    ...
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_RENAME,
                                   existing);
      SEGGER_SYSVIEW_RecordString (
    ...
    {
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_POSIX_RENAME, static_cast<U32> (res));
    }

    void
    unlink (const char* path)
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_UNLINK,
                                   path);
    }
    ...
    {
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_POSIX_UNLINK, static_cast<U32> (res));
    }
    ...
    utime (const char* path, const void* times)
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_UTIME,
                                   path);
      SEGGER_SYSVIEW_RecordU32 (OS_INTEGER_INSTRUMENTATION_ID_POSIX_UTIME_MORE,
    ...
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_STATVFS,
                                   path);
      SEGGER_SYSVIEW_RecordU32 (
    ...
    {
      SEGGER_SYSVIEW_RecordEndCallU32 (
          OS_INTEGER_INSTRUMENTATION_ID_POSIX_STATVFS, static_cast<U32> (res));
    }

    void
    opendir (const char* dirpath)
    {
      SEGGER_SYSVIEW_RecordString (OS_INTEGER_INSTRUMENTATION_ID_POSIX_OPENDIR,
                                   dirpath);
    }
    ...
    namespace file_system
    {
      ...
      vmount (void* fs, const char* path, unsigned int flags)
      {
        ...
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_VMOUNT_PATH, path);
      }
      ...
      vopen (void* fs, const char* path, int oflags)
      {
        SEGGER_SYSVIEW_RecordU32x2 (
            ...
            static_cast<U32> (oflags));
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_VOPEN_PATH, path);
      }
      ...
      mkdir (void* fs, const char* path, unsigned int mode)
      {
        SEGGER_SYSVIEW_RecordU32x2 (
            ...
            static_cast<U32> (mode));
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_MKDIR_PATH, path);
      }
      ...
      rmdir (void* fs, const char* path)
      {
        SEGGER_SYSVIEW_RecordU32 (
            ...
            SEGGER_SYSVIEW_ShrinkId (reinterpret_cast<U32> (fs)));
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_RMDIR_PATH, path);
      }
      ...
      chmod (void* fs, const char* path, unsigned int mode)
      {
        SEGGER_SYSVIEW_RecordU32x2 (
            ...
            static_cast<U32> (mode));
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_CHMOD_PATH, path);
      }
      ...
      unlink (void* fs, const char* path)
      {
        SEGGER_SYSVIEW_RecordU32 (
            ...
            SEGGER_SYSVIEW_ShrinkId (reinterpret_cast<U32> (fs)));
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_UNLINK_PATH, path);
      }
      ...
      utime (void* fs, const char* path, const void* times)
      {
        SEGGER_SYSVIEW_RecordU32x2 (
            ...
            reinterpret_cast<U32> (times));
        SEGGER_SYSVIEW_RecordString (
            OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_UTIME_PATH, path);
      }
