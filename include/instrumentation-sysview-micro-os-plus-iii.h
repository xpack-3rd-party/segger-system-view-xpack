...
#ifndef INSTRUMENTATION_SYSVIEW_MICRO_OS_PLUS_III_H_
#define INSTRUMENTATION_SYSVIEW_MICRO_OS_PLUS_III_H_
...
#define OS_INTEGER_INSTRUMENTATION_ID_POSIX_FILE_SYSTEM_VMOUNT_PATH \
...
{
  // Mandatory functions, to configure and start/stop the instrumentation.
  void
  configure (void);
  ...
  // Mandatory functions to record interrupts.
  namespace interrupt
  {
    void
    entered (void);
...
#endif // INSTRUMENTATION_SYSVIEW_MICRO_OS_PLUS_III_H_
